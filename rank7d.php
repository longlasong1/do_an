...
try {
    // Truy vấn lấy bài hát xếp hạng theo tuần từ cao đến thấp
    $sql = "SELECT song_id, title, ranking FROM rank7d ORDER BY ranking DESC";
...
<head>
    ...
    <title>Top Tuần - Website Nghe Nhạc</title>
...
<div class="sidebar">
    ...
    <a href="rank7d.php" style="background: #1abc9c;">📊 Xem top tuần</a> 
...
<div class="content">
    ...
    <table class="ranking-table">
        ...
        <?php else: ?>
            <tr>
                <td colspan="4">Chưa có bài hát nào trong bảng xếp hạng tuần.</td>
            </tr>
        <?php endif; ?>
    </table>
</div>
